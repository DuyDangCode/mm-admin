    ...
    <form onSubmit={form.onSubmit(handleSubmit)}>
      <div className=' flex flex-col items-stretch p-[16px]'>
        ...
        <Group mt='md' grow>
          ...
          <Button className='bg-0-primary-color-6 text-white' type='submit'>
            Tạo
          </Button>
        </Group>
      </div>
        ...
        <Modal.Content>
          <Modal.Header>
            <Modal.Title w='100%' ta='center'>
              <Text fw={700}>Tạo tài khoản nhân viên</Text>
            </Modal.Title>
            <Modal.CloseButton />
          </Modal.Header>
          <Modal.Body px='lg'>{Form}</Modal.Body>
        </Modal.Content>
      </Modal.Root>
    </ScrollArea>
  )
